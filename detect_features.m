...
img = imread('ima3.jpg');
    ...
    imshow(img)
    hold on
    %scatter(pts{1}(:,2),pts{1}(:,1))
    scatter(pts{2}(:,2),pts{2}(:,1))
    scatter(pts{3}(:,2),pts{3}(:,1))
    scatter(pts{4}(:,2),pts{4}(:,1))
    scatter(pts{5}(:,2),pts{5}(:,1))
    scatter(pts{6}(:,2),pts{6}(:,1))
    scatter(pts{7}(:,2),pts{7}(:,1))
    scatter(pts{8}(:,2),pts{8}(:,1))
    scatter(pts{9}(:,2),pts{9}(:,1))
    hold off
